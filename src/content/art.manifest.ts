...
export const ART_ASSETS: ArtAsset[] = [
  ...
  { path: 'art/nombres/nombres.gloutons-du-dix.fond.webp', kind: 'decor', island: 'nombres', game: 'gloutons-du-dix' },
  { path: 'art/nombres/nombres.fabrique-de-nombres.fond.webp', kind: 'decor', island: 'nombres', game: 'fabrique-de-nombres' },
  { path: 'art/nombres/nombres.ptit-marchand.fond.webp', kind: 'decor', island: 'nombres', game: 'ptit-marchand' },
  { path: 'art/nombres/nombres.bar-a-schemas.fond.webp', kind: 'decor', island: 'nombres', game: 'bar-a-schemas' },
  { path: 'art/nombres/nombres.calcul-aventure.fond.webp', kind: 'decor', island: 'nombres', game: 'calcul-aventure' },
  { path: 'art/nombres/nombres.balance-magique.fond.webp', kind: 'decor', island: 'nombres', game: 'balance-magique' },
  { path: 'art/nombres/nombres.riviere-aux-lucioles.fond.webp', kind: 'decor', island: 'nombres', game: 'riviere-aux-lucioles' },
  { path: 'art/nombres/nombres.boites-a-nombres.fond.webp', kind: 'decor', island: 'nombres', game: 'boites-a-nombres' },
  { path: 'art/nombres/nombres.pizzeria-des-fractions.fond.webp', kind: 'decor', island: 'nombres', game: 'pizzeria-des-fractions' },
