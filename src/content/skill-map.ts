...
export const SKILL_MAP: SkillDef[] = [
  ...
  // ---------------- MATHS — calcul et numération CE1 / CE2 (programme 2025, piste arcade) ----------------
  {
    id: 'ma.ce1.calc.complement-dizaine',
    label: 'Compléter à la dizaine supérieure',
    official: 'Calculer le complément d’un nombre à la dizaine supérieure',
    domain: 'maths',
    level: 'ce1',
    period: 1,
    prereqs: ['ma.cp.complements10', 'ma.cp.num.dizaines'],
  },
  {
    id: 'ma.ce1.calc.passage-dizaine',
    label: 'Additionner en passant la dizaine',
    official: 'Additionner deux nombres avec passage de la dizaine en s’appuyant sur les compléments à 10',
    domain: 'maths',
    level: 'ce1',
    period: 1,
    prereqs: ['ma.cp.add20', 'ma.ce1.calc.complement-dizaine'],
  },
  {
    id: 'ma.ce1.calc.complements100',
    label: 'Les compléments à 100',
    official: 'Calculer des compléments à 100 en s’appuyant sur les dizaines et les unités',
    domain: 'maths',
    level: 'ce1',
    period: 2,
    prereqs: ['ma.ce1.calc.complement-dizaine', 'ma.cp.num.decompo100'],
  },
  {
    id: 'ma.ce1.mult.tables-2-5-10',
    label: 'Les tables de 2, 5 et 10',
    official: 'Comprendre la multiplication comme addition réitérée ; mémoriser les tables de 2, 5 et 10',
    domain: 'maths',
    level: 'ce1',
    period: 2,
    prereqs: ['ma.cp.doubles'],
  },
  {
    id: 'ma.ce1.mult.tables-3-4',
    label: 'Les tables de 3 et 4',
    official: 'Mémoriser les tables de multiplication de 3 et 4',
    domain: 'maths',
    level: 'ce1',
    period: 4,
    prereqs: ['ma.ce1.mult.tables-2-5-10'],
  },
  {
    id: 'ma.ce1.calc.doubles-moities100',
    label: 'Doubles et moitiés jusqu’à 100',
    official: 'Connaître et utiliser les doubles et les moitiés de nombres jusqu’à 100',
    domain: 'maths',
    level: 'ce1',
    period: 3,
    prereqs: ['ma.cp.doubles', 'ma.cp.num.decompo100'],
  },
  {
    id: 'ma.ce1.num.complements1000',
    label: 'Les compléments à 1000',
    official: 'Utiliser les relations entre unités, dizaines et centaines jusqu’à 1000 ; compléter à la centaine et au millier',
    domain: 'maths',
    level: 'ce1',
    period: 3,
    prereqs: ['ma.ce1.calc.complements100'],
  },
  {
    id: 'ma.ce2.mult.tables-6-9',
    label: 'Les tables de 6, 7, 8 et 9',
    official: 'Compléter la mémorisation des tables de multiplication : tables de 6, 7, 8 et 9',
    domain: 'maths',
    level: 'ce2',
    period: 2,
    prereqs: ['ma.ce1.mult.tables-3-4'],
  },
  {
    id: 'ma.ce2.num.complements10000',
    label: 'Jusqu’à 10 000 en milliers',
    official: 'Connaître et utiliser les relations entre les unités de numération jusqu’à 10 000',
    domain: 'maths',
    level: 'ce2',
    period: 2,
    prereqs: ['ma.ce1.num.complements1000'],
  },
  // ---------------- MATHS — monnaie (CP) ----------------
  {
