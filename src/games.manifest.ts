...
export const V2_COMPONENTS: Record<string, LazyExoticComponent<ComponentType>> = {
  ...
  'food-truck-gloutons': lazy(() => import('@/games/food-truck-gloutons')),
...
export const GAMES: GameMeta[] = [
  ...
  {
    // Piste arcade 3D (arcade-direction.md) — CE1/CE2, scénario dans arcade/food-truck-gloutons/
    ...
    skills: [
      ...
      'ma.ce1.calc.complement-dizaine',
      'ma.ce1.calc.passage-dizaine',
      'ma.ce1.calc.complements100',
      'ma.ce1.mult.tables-2-5-10',
      'ma.ce1.mult.tables-3-4',
      'ma.ce1.calc.doubles-moities100',
      'ma.ce1.num.complements1000',
      'ma.ce2.mult.tables-6-9',
      'ma.ce2.num.complements10000',
    ],
    status: 'v2',
    tag: 'arcade',
  },
