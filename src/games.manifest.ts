...
export const GAMES: GameMeta[] = [
  ...
  { id: 'v1-calcul-aventure', title: 'Calcul Aventure (classique)', tagline: 'Additions et soustractions', icon: '🔢', island: 'nombres', accent: '#3498db', skills: [], status: 'classique', href: 'v1/calcul-aventure.html' },
  ...
  { id: 'v1-le-bar-a-schemas', title: 'Le Bar à Schémas (classique)', tagline: 'Résous des problèmes en barres', icon: '📊', island: 'nombres', accent: '#00796b', skills: [], status: 'classique', href: 'v1/le-bar-a-schemas.html' },
