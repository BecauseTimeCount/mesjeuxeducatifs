...
**Des mini-jeux gratuits, sans pub et sans tracking, pour accompagner les enfants de la Grande Section au CE1.**

> 100% navigateur. Zero installation. Zero compte a creer. Ouvrez et jouez.
...
Pas de serveur, pas de base de données, pas de cookies. Les scores sont sauvegardés localement dans le navigateur de votre enfant. **Aucune donnée ne quitte jamais l'appareil.**
...
| **Calcul Aventure** | Additions et soustractions sous forme de defis | Calcul mental, numeration |
| **Premiere Lettre** | Trouve par quelle lettre commence le mot | Conscience phonologique |
| **Le Temps qui Passe** | Decouvre les heures et les moments de la journee | Reperage temporel, lecture de l'heure |
...
Astuce : sur tablette/telephone, ajoutez la page a l'ecran d'accueil pour un acces comme une vraie application.
...
- **Niveaux de difficulte** : chaque jeu s'adapte avec plusieurs niveaux progressifs
- **Mode plein ecran** : ideal sur tablette, sans distractions
- **100% offline** : fonctionne sans connexion apres le premier chargement
- **Responsive** : s'adapte a toutes les tailles d'ecran (tablette, telephone, PC)
...
Ce projet est concu pour evoluer avec l'enfant :

- [ ] **CP** — Lecture de mots simples, additions jusqu'a 20, introduction de la monnaie
- [ ] **CE1** — Petits textes a trous, multiplications, problemes de logique
- [ ] **PWA complete** — Manifest + Service Worker pour une vraie app installable
- [ ] **Nouveaux jeux** — Memory, jeu de l'oie educatif, dictee de lettres
- [ ] **Mode parent** — Tableau de bord pour suivre la progression
